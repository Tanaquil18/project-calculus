...
},
{
  ...
  "body": " The derivative function   Under construction    Before Class   Graphing the Derivative of a Quadratic Function  This graphical exploration walks students through how to use the slopes of the graph of a quadratic function to graph the function's derivative, reinforcing the idea that the derivative is itself a function with inputs and outputs.   Learning objectives for this activity   use the slopes of to identify the heights, or values, of   find where the roots of are by looking at a graph of   view the derivative as a function with inputs and outputs   .     Graphing the Derivative of a More Complicated Function  This graphical exploration leads students to identify key features of the graph of a function and see how those translate to the graph of the function's derivative, reinforcing the idea that the derivative is itself a function with inputs and outputs.   Learning objectives for this activity   use the slopes of to identify the sign of the heights, or values, of   find where the roots of are by looking at a graph of   view the derivative as a function with inputs and outputs   .      During Class - Hour 1    During Class - Hour 2   "
},
{
  "id": "ex-deriv-fxn-name1",
  "level": "2",
  "url": "sec-deriv-fxn.html#ex-deriv-fxn-name1",
  "type": "Exploration",
  "number": "1.4.1",
  "title": "Graphing the Derivative of a Quadratic Function.",
  "body": " Graphing the Derivative of a Quadratic Function  This graphical exploration walks students through how to use the slopes of the graph of a quadratic function to graph the function's derivative, reinforcing the idea that the derivative is itself a function with inputs and outputs.   Learning objectives for this activity   use the slopes of to identify the heights, or values, of   find where the roots of are by looking at a graph of   view the derivative as a function with inputs and outputs   .   "
},
{
  "id": "ex-deriv-fxn-name2",
  "level": "2",
  "url": "sec-deriv-fxn.html#ex-deriv-fxn-name2",
  "type": "Exploration",
  "number": "1.4.2",
  "title": "Graphing the Derivative of a More Complicated Function.",
  "body": " Graphing the Derivative of a More Complicated Function  This graphical exploration leads students to identify key features of the graph of a function and see how those translate to the graph of the function's derivative, reinforcing the idea that the derivative is itself a function with inputs and outputs.   Learning objectives for this activity   use the slopes of to identify the sign of the heights, or values, of   find where the roots of are by looking at a graph of   view the derivative as a function with inputs and outputs   .   "
},
{
  "id": "backmatter-2",
  "level": "1",
